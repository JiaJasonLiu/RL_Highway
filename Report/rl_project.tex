...
Actor-Critic RL approaches is implemented in for PPO \cite{konda_actor-critic_1999}. This includes two networks, where \texttt{critic} learns to approximate the state value function, and \texttt{actor} accordingly maps from states to actions. For 
