...
\subsection{Double}
As the DQN is overestimating the Q Values which would not lead to optimal policy. 

\subsection{Noisy Network}
The Noisy Network would

\subsection{Prioritized Experience Replay}
This uses a structure to properly find the best Transition
